    ...
    <div className="mx-auto max-w-5xl px-4 py-8 md:px-8">
      ...
      {loading ? (
        ...
        <div className="rounded-2xl border border-border bg-card p-8 text-muted-foreground">
          No assignments in groups where you are a teacher yet. Create homework from{" "}
          <Link href={homeworkManagementHref} className="font-semibold text-primary underline">
            {homeworkManagementLabel}
          </Link>
          .
        </div>
