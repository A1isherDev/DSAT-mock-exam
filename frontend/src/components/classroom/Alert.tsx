...
const toneClass: Record<ClassroomAlertTone, string> = {
  ...
  info: "border-violet-200/80 bg-gradient-to-r from-violet-50/90 to-cyan-50/40 text-slate-800 dark:border-violet-500/25 dark:from-violet-950/30 dark:to-cyan-950/20 dark:text-slate-200",
};
