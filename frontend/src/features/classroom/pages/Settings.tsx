...
/** Edit core class details. Owner/Teacher only (gated by the workspace). */
export function Settings({ classroom }: { classroom: ClassroomWithRole }) {
  const update = useUpdateClass(Number(classroom.id));
    ...
    <Card>
      ...
      <div className="mt-5 max-w-lg space-y-4">
        ...
        <label className="flex items-center gap-2.5 text-sm text-foreground">
          ...
          />
          Class is active (students can join and see it)
        </label>
